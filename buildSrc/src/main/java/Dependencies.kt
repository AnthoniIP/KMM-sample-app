/** PLAYSTORE VERSIONS */
object Playstore {
    const val applicationId = "com.ipsoft.kmmsampleproject.android" // can't change once defined
    const val compileSdk = 33
    const val minSdk = 23
    const val targetSdk = 33
    const val versionCode = 1       // must be increased by every playstore upload
    const val versionName =
        "1.0.0" // you should increase too. Suggested approach (https://semver.org/)
}

object Namespaces {
    const val android = "com.ipsoft.kmmsampleproject.android"
    const val shared = "com.ipsoft.kmmsampleproject"
}
...
object Jetbrains {
    ...
    const val serializationKotlinCore =
        "org.jetbrains.kotlinx:kotlinx-serialization-core:${Versions.kotlinSerializationCore}"
}
...
object Test {
    ...
    const val instrumentedTestCompose =
        "androidx.compose.ui:ui-test-junit4:${Versions.instrumentedTestCompose}"
    ...
    const val instrumentedCommonEspresso =
